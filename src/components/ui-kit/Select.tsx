...
export const Select = ({text, options, defaultValue}: SelectType) => {
        ...
        <div>
            <div className={'flex flex-col w-80 relative'}>
                ...
                {selected && <div className=' z-10	absolute w-full right-0 top-24 bg-base-inputs rounded scroll-py-2	 h-44 overflow-auto'>
                    {options.map(el => (<div onClick={()=>onClickCityHandler(el.text)} className='flex py-2.5 justify-between px-4 text-primary text-base font-medium font-inter'>
                        {el.text}
