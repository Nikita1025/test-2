    ...
    <div className="flex flex-col w-80 relative">
      ...
      <div className=" flex justify-between ">
        <input
          ...
          className="px-6 py-3 bg-base-inputs rounded-md text-primary w-full focus:outline-none  focus:ring-0"
        />
      ...
      <div className="w-full absolute top-17">
        ...
        />
        {minMaxValue && (
          <div className="mt-1.5 flex justify-between	h-5	mb-18 ">
        ...
        {infoWindow && (
          <div className="flex py-1.5 px-3	bg-base-secondary rounded">
